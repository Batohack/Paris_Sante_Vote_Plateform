...
<head>
    ...
    <title>Inscription - Concours Miss/Master</title>
...
<body class="min-vh-100 d-flex flex-column">
    ...
    <main class="flex-grow-1 py-5 bg-gray-light">
        <div class="container mx-auto px-4">
            <h1 class="text-center fs-2 fw-bold mb-5">Inscription</h1>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="bg-white rounded-xl shadow-md p-4">
                        ...
                        <p class="text-center mt-3">
                            Déjà un compte ? <a href="login.php" class="text-purple">Se connecter</a>
                        </p>
                    </div>
                </div>
            </div>
